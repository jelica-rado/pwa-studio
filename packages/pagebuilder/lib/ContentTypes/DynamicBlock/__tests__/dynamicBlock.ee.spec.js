...
import { DISPLAY_MODE_FIXED_TYPE } from '@jelica-rado/venia-ui/lib/components/CmsDynamicBlock';

import DynamicBlock from '../dynamicBlock.ee';

jest.mock('@jelica-rado/venia-ui/lib/components/CmsDynamicBlock', () => props => (
