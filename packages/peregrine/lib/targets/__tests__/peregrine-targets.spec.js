...
test('exposes all hooks and targets', async () => {
    ...
    bus.init();
    const apis = {};
    const { talons, hooks } = bus.getTargetsOf('@jelica-rado/peregrine');
    ...
    expect(apis.hooks).toMatchInlineSnapshot(`
        HookInterceptorSet API (autogenerated from "@jelica-rado/peregrine/lib/hooks"):
    ...
    expect(apis.talons).toMatchInlineSnapshot(`
        HookInterceptorSet API (autogenerated from "@jelica-rado/peregrine/lib/talons"):
